...
<div class="profile-card">
  ...
  <div class="profile-info">
    ...
    <div class="profile-title"><span>@</span>{{ $usuario->username }}</div>
    <div class="profile-bio">{{ $usuario->biografia }}
    </div>
  ...
  <a class="cta-button">Editar perfil</a>
  <div class="stats">
    <div class="stat-item">
      <div class="stat-value">{{ $usuario->birth }}</div>
      <div class="stat-label">Fechad de nacimiento</div>
    </div>
    <div class="stat-item">
      <div class="stat-value">{{ $usuario->libros->count() }}</div>
